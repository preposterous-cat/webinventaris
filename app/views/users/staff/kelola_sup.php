            ...
            foreach ($data['data_sup'] as $datas):?>
              <tr>
                ...
                <td class="d-block d-md-table-cell ps-0">
                  <a class="d-md-none text-decoration-none ps-0" href="<?php echo URLROOT . '/Users/lihat_sup_page/' . $datas->id_supplier ?>"><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat"><i class="align-middle" data-feather="eye"></i></button></a>
                  <a class="text-decoration-none ps-0" href="<?php echo URLROOT . '/Users/edit_sup_page/' . $datas->id_supplier ?>"><button type="button" class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="align-middle" data-feather="edit"></i></button></a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="<?php echo URLROOT . '/Users/hapus_sup/' . $datas->id_supplier ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                    </div>
                  </div>
                </div>
              </div>
