					...
					<div class="col-sm-3">
						<div class="card">
							<div class="card-body">
								...
								<div class="mb-0">
									<a class="text-user text-decoration-none" href="<?php echo URLROOT . '/Users/kelola_barang_page' ?>">More Info<i class="float-end text-user" data-feather="arrow-right"></i></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="card">
							<div class="card-body">
								...
								<div class="mb-0">
									<a class="text-user text-decoration-none" href="<?php echo URLROOT . '/Users/kelola_sup_page' ?>">More Info<i class="float-end text-user" data-feather="arrow-right"></i></a>
								</div>
							</div>
						</div>
					</div>
