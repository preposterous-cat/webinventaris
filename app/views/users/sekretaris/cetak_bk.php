<main class="content">
  <div class="row">
    <div class="col-12 d-flex">
      <div class="card flex-fill">
        <div class="card-header">
          <h5 class="card-title mb-0">Unduh Barang Keluar Berdasarkan Tanggal</h5>
        </div>
        <div class="card-body">
          <form action="<?php echo URLROOT . '/Users/cetak_bk' ?>" method="POST">
            <div class="mb-3">
            ...
            <div class="text-start">
              <button type="submit" class="btn btn-lg bg-user text-white">Unduh</button>
            </div>
          </form>
        </div>
      </div>
    ...
    <div class="col-12 d-flex">
      <div class="card flex-fill">
        <div class="card-header">
          <h5 class="card-title mb-0">Unduh Barang Keluar Berdasarkan Barang</h5>
        </div>
        <div class="card-body">
          <form action="<?php echo URLROOT . '/Users/cetak_bk2' ?>" method="POST">
          <div class="mb-3">
