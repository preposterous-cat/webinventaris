            ...
            foreach ($data['data_barang'] as $datas) :?>
              <tr>
                ...
                <td class="d-block d-md-table-cell">
                  <a class="text-decoration-none" href="<?php echo URLROOT . '/Admin/lihat_barang_page/' . $datas->id_barang ?>"><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat"><i class="align-middle" data-feather="eye"></i></button></a>
                  <a class="text-decoration-none" href="<?php echo URLROOT . '/Admin/edit_barang_page/' . $datas->id_barang ?>"><button type="button" class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="align-middle" data-feather="edit"></i></button></a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="<?php echo URLROOT . '/Admin/hapus_barang/' . $datas->id_barang ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                    </div>
                  </div>
                </div>
              </div>
